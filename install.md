...
- сервис станет доступен локально на вашем компьютере
...
Если вам нужен не пользовательский запуск через Docker, а разработка в
репозитории, переходите к `README_ru.md`: там описаны `make venv`,
хуки и локальные dev-команды.
